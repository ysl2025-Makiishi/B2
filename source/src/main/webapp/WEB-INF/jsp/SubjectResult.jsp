...
<body>
    <div class="wrapper">
        ...
        <ul class="subject-nav">
            <li><a href="<c:url value='/SubjectResultServlet?studentId=${student.id}&subjectId=1' />">国語</a></li>
            <li><a href="<c:url value='/SubjectResultServlet?studentId=${student.id}&subjectId=3' />">数学</a></li>
            <li><a href="<c:url value='/SubjectResultServlet?studentId=${student.id}&subjectId=4' />">理科</a></li>
            <li><a href="<c:url value='/SubjectResultServlet?studentId=${student.id}&subjectId=2' />">社会</a></li>
            <li><a href="<c:url value='/SubjectResultServlet?studentId=${student.id}&subjectId=5' />">英語</a></li>
            <li><a href="<c:url value='/SubjectResultServlet?studentId=${student.id}&subjectId=10' />">総合</a></li>
        </ul>

        <!-- メッセージ表示 -->
        <c:if test="${not empty message}">
            <div class="message" style="background: lightgreen; padding: 10px; margin: 10px; border-radius: 5px;">
                ${message}
            </div>
        </c:if>
                ...
                <tbody>
                    <c:forEach var="exam" items="${subjectData.examResults}">
                        <tr>
                            ...
                            <td>
                                <input type="number" value="${exam.deviationValue}" id="dev_${exam.id}" step="0.1" />
                            </td>
                            <td>
