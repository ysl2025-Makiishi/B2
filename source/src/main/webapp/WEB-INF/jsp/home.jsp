...
<body id="home">
	<div class="wrapper">
		...
		<div class="help-content">
		  ...
		  模試名・実施日・教科・点数・偏差値・平均などを入力してください。</p>
		
		  <h3>📘 学習計画を見直したいとき</h3>
		  <p>「科目ごと結果」の学習計画では、生徒に合ったテキストや宿題の進捗管理ができます。<br>
		  理解度に応じて内容の調整も可能です。</p>
		
		  <h3>✨ このアプリでできること</h3>
		  <ul>
		    <li>性格診断で個別最適な学習を実現  
		      <br>→ 生徒は8問の簡単なアンケートに答えることで、4タイプの性格（開放性・勤勉性・協調性・神経性）に分類されます。</li>
		    <li>性格に合った教材を自動で選出  
		      <br>→ 性格診断の結果に応じて最適なテキストが提案されます。</li>
		    <li>理解度に応じたスケジュールを自動作成  
		      <br>→ 理解度は10段階評価で、生徒にあった適切な1日に進めるテキストページ数を提案します。</li>
		    <li>宿題の分量を自動作成  
